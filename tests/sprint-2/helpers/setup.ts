/**
 * Shared test-database helpers for Sprint 2 tests.
 *
 ...
 * Uses deleteMany() (= DELETE FROM) rather than TRUNCATE so Prisma handles
 * the FK cascade order automatically via individual statements.
 */
export async function cleanDatabase(prisma: PrismaClient): Promise<void> {
  // Delete in leaf-to-root order to satisfy FK constraints.
